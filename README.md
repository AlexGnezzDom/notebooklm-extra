...
- **Ширина окна критична.** Ниже ~1300px NotebookLM схлопывает колонки в табы «Источники / Чат / Студия», и список источников исчезает из DOM — инструменты вернут ноль. В headless размер задаётся явно (`NLM_WINDOW_WIDTH`, по умолчанию 1600).
...
Три ловушки вёрстки, на которые стоит обратить внимание при починке:
